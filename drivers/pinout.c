...
PinoutSet(void)
{
    ...
    //Tomi changed this needed to reroute for PD4,PD5, UART2 needs to be configured instead of UART0)
...
ROM_GPIOPinTypeUART(GPIO_PORTD_BASE,GPIO_PIN_4|GPIO_PIN_5);
    ...
    //TK ROM_GPIOPinTypeGPIOInput(GPIO_PORTT_BASE, GPIO_PIN_2 | GPIO_PIN_3);
